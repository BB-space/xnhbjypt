...
public class SMSUtil {
	...
	static String account = "JSM40400";//
	//密码
	static String password = "74rnm04w";//
	//校验码
	static String veryCode = "vu9r76vpujfb";
...
//		params.append("&sendtime=").append("20151001113000"); //发送定时短信
	...
	public static void main(String[] args) throws Exception{
		String result = "";
		//发送普通短信
		//result = sendTextSms("13750058205", "您的验证码为：654321，请勿向任何人提供短信验证码");
		
		//发送模版短信
		result = sendTemplateSms("15989750071", "JSM40400-0001", "@1@=123456");
