...
<html>
<head>
<jsp:include page="${pageContext.request.contextPath}/resource/jsp/background/meta.jsp"></jsp:include>
<jsp:include page="${pageContext.request.contextPath}/resource/jsp/background/easyui.jsp"></jsp:include>
<jsp:include page="${pageContext.request.contextPath}/resource/jsp/background/easyui-portal.jsp"></jsp:include>
