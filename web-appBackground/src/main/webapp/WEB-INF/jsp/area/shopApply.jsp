...
<!-- 				</tr> -->
				...
				<tr>
					<td align="right">店长手机：</td>
					<td><input name="mobile" style="width: 200px;" maxlength="11"
						class="easyui-validatebox" required="true" /></td>
				</tr>
				<tr>
					<td align="right">支付宝结算帐号：</td>
				...
				<tr>
					...
					<td>
						<textarea rows="8" cols="30" style="width:200px;resize:none;font-size: 6px;" name="address"
						 class="easyui-validatebox" placeHolder="[手机号1]修改为[手机号2]&#10;[门店名字1]修改为[门店名称2]&#10;&#10;支付宝帐号修改必须写文字版的备忘"></textarea>	
					</td>
				</tr>
<!-- 				<tr> -->
<!-- 					<th>门店架构编码：</th> -->
