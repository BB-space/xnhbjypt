...
<body class="easyui-layout" fit="true">
	<div region="center" border="false" style="overflow: hidden;">
		<div class="head_top">商城>>banner图片>>添加</div>
		<div class="widget_main">
			<form enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath}/mallBanner/toAddMallBanner.do">
				<div class="division">
						...
						<tr>
							...
							<td>
								<select style="width: 150px;" name="parentId">
									<option value="0" label="banner广告">banner广告</option>
									<option value="1" label="banner商品">banner商品</option>
								</select>
							</td>
						</tr>
						<tr>
