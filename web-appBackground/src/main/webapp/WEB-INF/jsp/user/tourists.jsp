...
<script type="text/javascript" charset="UTF-8">
	...
	$(function() {
		...
		userRoleForm = $('#userRoleForm').form({
			url : '${pageContext.request.contextPath}/tourists.do?editUsersRole',
				...
				handler : function() {
					if (userForm.find('[name=id]').val() != '') {
						...
						userForm.form('submit', {
							url : '${pageContext.request.contextPath}/tourists.do?edit',
							success : function(data) {
						...
						if(!checkData())return;
						userForm.form('submit', {
							url : '${pageContext.request.contextPath}/tourists.do?add',
							success : function(data) {
								try {
									var d = $.parseJSON(data);
									if (d) {
		...
		datagrid = $('#datagrid').datagrid({
			url : '${pageContext.request.contextPath}/tourists.do?datagrid',
			toolbar : '#toolbar',
			title : '',
			iconCls : 'icon-save',
			pagination : true,
