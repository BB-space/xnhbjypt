...
<script type="text/javascript" charset="UTF-8">
	...
	$(function() {
		...
		userRoleForm = $('#userRoleForm').form({
			url : '${pageContext.request.contextPath}/shopAdmin.do?editUsersRole',
				...
				handler : function() {
					if (userForm.find('[name=id]').val() != '') {
						...
						userForm.form('submit', {
							url : '${pageContext.request.contextPath}/shopAdmin.do?edit',
							success : function(data) {
								var d = $.parseJSON(data);
								if(d.success==true){
						...
						/* if(!checkData()) return; */
						userForm.form('submit', {
							url : '${pageContext.request.contextPath}/shopAdmin.do?add',
							success : function(data) {
								var d = $.parseJSON(data);
								//alert(d.obj);
									if (d.obj=="4") {
		...
		datagrid = $('#datagrid').datagrid({
			url : '${pageContext.request.contextPath}/shopAdmin.do?datagrid',
			toolbar : '#toolbar',
			title : '',
			iconCls : 'icon-save',
			pagination : true,
