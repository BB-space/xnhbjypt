...
<script type="text/javascript" charset="UTF-8">
	...
	$(function() {
		...
		userRoleForm = $('#userRoleForm').form({
			url : '${pageContext.request.contextPath}/shopManager.do?editUsersRole',
				...
				handler : function() {
					if (userForm.find('[name=id]').val() != '') {
						...
						userForm.form('submit', {
							url : '${pageContext.request.contextPath}/shopManager.do?edit',
							success : function(data) {
								var d = $.parseJSON(data);
								if(d.success==true){
						...
						/* if(!checkData()) return; */
						userForm.form('submit', {
							url : '${pageContext.request.contextPath}/shopManager.do?add',
							success : function(data) {
								var d = $.parseJSON(data);
								//alert(d.obj);
									if (d.obj=="3") {
		...
		datagrid = $('#datagrid').datagrid({
			url : '${pageContext.request.contextPath}/shopManager.do?datagrid',
			toolbar : '#toolbar',
			title : '',
			iconCls : 'icon-save',
			pagination : true,
