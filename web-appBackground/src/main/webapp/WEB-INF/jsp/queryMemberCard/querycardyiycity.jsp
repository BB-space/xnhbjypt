...
<script type="text/javascript" charset="UTF-8">
	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			url : '${pageContext.request.contextPath}/queryMemberCard.do?yiycityDatagrid',
			toolbar : '#toolbar',
			title : '',
			iconCls : 'icon-save',
			pagination : true,
			...
			columns :[[{
				field : 'virtualSixCount',
				title : '69购买数量',
				width : 20,
			},{
				field : 'virtualEightCount',
				title : '198购买数量',
				width : 20,
			}]]
		});
	...
	function exportCurData(){
		window.location.href="${pageContext.request.contextPath}/queryMemberCard.do?exportSixAndNightBuy&name="
				+encodeURI(encodeURI(cityName))+"&startDate="+encodeURI(encodeURI(startDate))
