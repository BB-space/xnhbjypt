...
<script type="text/javascript">
	...
	$(function() {
		datagrid = $('#datagrid').datagrid({
			url : '${pageContext.request.contextPath}/userCardVerify.do?shopViewDatagrid',
			toolbar : '#toolbar',
			title : '',
			iconCls : 'icon-save',
			pagination : true,
		...
		$("#cityName").combobox({
			valueField: 'cityName',
	        textField: 'cityName',
	        url: 'userCardVerify.do?shopCityName',
				...
				<table class="tableForm">
					<tr>
						...
						<td><input name="toDate" class="easyui-datebox" data-options="editable:false" 
						    id="toDate"/></td>
						<td>城市</td>
						<td><select id="cityName" class="easyui-combobox" name="cityName" style="width:150px;"
