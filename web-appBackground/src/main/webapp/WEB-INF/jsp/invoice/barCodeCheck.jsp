...
<script type="text/javascript" charset="UTF-8">
	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			url : '${pageContext.request.contextPath}/barCodeCheck/datagrid.do',
			toolbar : '#toolbar',
			title : '',
			iconCls : 'icon-save',
			pagination : true,
			...
			columns :[[{
				...
				width : 20,
				formatter:function(value,row,index){
					return '<button onclick="picking(\''+row.id+'\')">验货</button>';
				}
			}]]
		});
	...
	function picking(value){
		window.location.href='${pageContext.request.contextPath}/barCodeCheck/barCodeCheckDetail.do?id='+value;
	}
</script>
</head>
