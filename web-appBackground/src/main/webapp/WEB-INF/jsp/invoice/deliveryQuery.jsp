...
<script type="text/javascript" charset="UTF-8">
	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			url : '${pageContext.request.contextPath}/deliveryQuery/datagrid.do',
			toolbar : '#toolbar',
			title : '',
			iconCls : 'icon-save',
			pagination : true,
		...
		<div id="toolbar" class="datagrid-toolbar"
			...
			<fieldset>
				...
				<table class="tableForm">
					<tr>
						<td>发货时间<input class="easyui-datebox"/>至<input class="easyui-datebox"/>
						</td>
						<td style="width:100px;"></td>
						<td>名称</td>
						<td><input name="deliveryNo" placeholder="发货单号"/></td>
