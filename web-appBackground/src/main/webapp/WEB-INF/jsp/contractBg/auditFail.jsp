...
<body class="" fit="true">
	...
	<div class="contant">
			...
			<div class="box"><div class="table"><span>${userM.userName}</span></div></div>
...
<div class="pwd-box" id="pwd-box">
	...
	<div class="maindiv" region="center" border="false" style="overflow: auto;">
		<div style="text-align: center;">
			<p style="font-size:14px;font-weight: bold;margin-top:80px;color: #990000">您的审核未通过！</p>
			<p style="font-size:16px;font-weight: bold;margin-top:30px;color: #777777">
				未通过原因如下，请按要求修改资料
			</p>
			<div>
				<textarea id="auditFailNote" rows="8" cols="" style="resize:none;width:440px;text-align: left;padding:8px 4px;margin-top:30px" 
				placeholder="" readonly="readonly">${contractM.auditFailNote}</textarea>
			</div>
