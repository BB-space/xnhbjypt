...
<script type="text/javascript" charset="UTF-8">
	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			url : '${pageContext.request.contextPath}/contract.do?datagridAudit',
			toolbar : '#toolbar',
			title : '',
			iconCls : 'icon-save',
			pagination : true,
	...
	function searchFun() {
		...
		var auditStatus = $('#toolbar select[name=auditStatus]').val();
		if(realname!="" || shopName!=""||auditStatus!=""){
			datagrid.datagrid('load',{
				realname : $('#toolbar input[name=realname]').val(),
				shopName : $('#toolbar input[name=shopName]').val(),
				auditStatus : $('#toolbar select[name=auditStatus]').val()
			});
		}else{
			...
			<!-- <fieldset>
				...
				<table class="tableForm">
					<tr>
						...
						<td>
							<select style="width:100px;text-align: center;" name="auditStatus">
								<option>请选择</option>
