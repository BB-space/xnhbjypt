...
<body class="easyui-layout" fit="true">
	<div region="center" border="false" style="overflow: hidden;">
		...
		<form method="post" action="${pageContext.request.contextPath}/qaPhase/toAdd.do">
			<table>
				<tr>
					<td>标题</td>
					<td><input type="text" id="text" name="title" class="easyui-validatebox" required="required"></td>
				</tr>
				<tr>
					<td>显示状态</td>
					<td>
