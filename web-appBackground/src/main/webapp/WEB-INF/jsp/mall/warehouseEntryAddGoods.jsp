...
$(function() {
	...
	$('#ButonGetCheck').click(function(){
		...
		$.post("${pageContext.request.contextPath}/warehouseEntry/addGoodsItem.do",{ids:names.join(",")},function(data){
			cnosole.log(data);
		});
		window.location.href="${pageContext.request.contextPath}/warehouseEntry/warehouseEntryAdd.do";
	})
});
</script>
