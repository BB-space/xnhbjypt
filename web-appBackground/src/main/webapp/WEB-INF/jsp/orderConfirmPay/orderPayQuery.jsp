...
<script type="text/javascript" charset="UTF-8">
	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			url : '${pageContext.request.contextPath}/orderConfirmPay/payQueryDatagrid.do',
			toolbar : '#toolbar',
			title : '',
			iconCls : 'icon-save',
			pagination : true,
...
// 				width : 50,
// 				formatter:function(value,row,index){
// 					return '<button onclick="confirmPay(\''+row.id+'\')">我要退款</button>';
// 				}
			} ] ]
		});
	});
...
// 		$.post('${pageContext.request.contextPath}/orderQueryPay/editConfirmPay.do',{id:value},function(data){
