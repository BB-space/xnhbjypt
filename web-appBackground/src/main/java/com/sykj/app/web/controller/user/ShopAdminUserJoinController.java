...
@Controller
@RequestMapping("/shopAdminJoin")
public class ShopAdminUserJoinController extends BaseController{
	...
	public EasyuiDataGridJson datagrid(HttpServletRequest request, UserM userM,
			EasyuiDataGrid dg) {
		return userService.datagrids(dg,userM,"10");
	}
