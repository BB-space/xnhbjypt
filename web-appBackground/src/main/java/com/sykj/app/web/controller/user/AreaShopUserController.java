...
@Controller
@RequestMapping("/areaShop")
public class AreaShopUserController extends BaseController{
	...
	public String user(HttpServletRequest req) {
		List<Object []> obj=cityService.findByGroupType();
		req.getSession().setAttribute("obj", obj);
		return "/user/area";
	}
	/**
	 * 用户注销
	...
	@ResponseBody
	public EasyuiDataGridJson datagrid(HttpServletRequest req, UserM userM,
			EasyuiDataGrid dg) {
	
		return userService.datagrids(dg,userM,"6");
	}
