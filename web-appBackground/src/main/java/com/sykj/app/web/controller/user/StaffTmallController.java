...
@Controller
@RequestMapping("/staffTmall")
public class StaffTmallController extends BaseController{
	...
	public EasyuiDataGridJson datagrid(HttpServletRequest request, UserM userM,
		...
		return userService.datagridsStaff(dg,userM,"1",um);
	}
