...
public class HttpRequestUtils {
    ...
    public static void main(String[] args) {
        //发送 GET 请求
    	JSONObject s=HttpRequestUtils.httpGet("http://api.btctrade.com/api/ticker?coin=btc");
        ...
        //发送 POST 请求
       // JSONObject sr=HttpRequestUtils.httpPost("http://localhost:6144/Home/RequestPostString", "key=123&v=456");
        //high: 最高价
        //low: 最低价
       // buy: 买一价
        //sell: 卖一价
